package pack05_stream.sec03_TerminalOperations.EX11_OptionalPrimitiveMethods;

import java.util.stream.DoubleStream;
import java.util.stream.IntStream;
import java.util.stream.LongStream;

public class EX11_OptionalPrimitiveMethods {
	public static void main(String[] args) {
		
		//#. OptionalXXX ¸Þ¼­µå (isPrsent(), ifPresent(), orElse(), getAsXXX()
		//#1. isPrsent()
